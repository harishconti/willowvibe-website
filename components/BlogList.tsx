      ...
      <div className="lg:w-1/3 space-y-8">
        <div className="bg-teal-900 rounded-2xl p-8 text-white relative overflow-hidden">
             <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-4">Free SaaS Guide 2025</h3>
                <p className="text-teal-100 mb-6 text-sm">
                    Everything you need to build scalable, secure SaaS products. 50+ pages of insights.
                </p>
                <Link href="/resources/saas-guide" className="block w-full py-3 bg-white text-teal-900 text-center font-bold rounded-lg hover:bg-teal-50 transition-colors">
                    Download PDF
                </Link>
             </div>
             {/* Decorative circles */}
             <div className="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 bg-teal-800 rounded-full opacity-50"></div>
             <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-32 h-32 bg-teal-800 rounded-full opacity-50"></div>
        </div>

        {/* Placeholder for other sidebar items if needed */}
      </div>
    </div>
  );
}
